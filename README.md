...
If you want to submit a Paperzilla skill to a shared skill directory such as `scientific-agent-skills`, use the unpacked exports in this repo instead of a release ZIP.
...
These directories are generated by the build, match the packaged release assets, and are intended to stay compatible with the Agent Skills specification.
